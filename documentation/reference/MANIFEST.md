...
- [colleague-repo-divergence.md](colleague-repo-divergence.md) — the colleague fork's test split IS its validation split; what each side has that the other lacks
- [fakeclue-dataset-properties.md](fakeclue-dataset-properties.md) — floors, composition, and why 0.68 is not a result there
...
- [sid-set-geometry-is-a-label.md](sid-set-geometry-is-a-label.md) — every SID-Set fake is 1024×1024 and 96% of reals are not square; resize keeps the resampling asymmetry; what it costs the AT arms
