# Project brain — TrustFake framework

Start here. Read this file plus `handoff/current-state.md`; open other leaves only when the
task needs them.
...
models at chance cross-dataset; FARE stabilises Φ); **Track C (auxiliary depth head + depth-
consistency rejection score) is built and tested on the Mac, not yet run** — the chain
`jobs/track_c_depth.sh` is staged for the 3090 box.
