...
- [track-c-white-box-cells-are-in-domain-only.md](track-c-white-box-cells-are-in-domain-only.md) — a white-box query cell through the teacher is 2.3 GPU-hours; only the four cells H(d) reads run, and evaluation has its own batch size
